...
(13, 'Kerapian dan Penampilan', 10),
(14, 'Kerjasama Tim', 15),
(15, 'Etika dan Perilaku', 15);
(16, 'Kedisiplinan', 25);
(17, 'Tanggung Jawab Terhadap Pekerjaan', 20);
(18, 'Inisiatif dan Kretifitas', 15);
...
CREATE TABLE `nilai` (
  ...
  `n_kerapian` int(3) NOT NULL,
  `n_kerjasama` int(3) NOT NULL,
  `n_etika` int(3) NOT NULL
  `n_kedisiplinan` int(3) NOT NULL
  `n_tanggungjawab` int(3) NOT NULL
  `n_inisiatif` int(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `nilai` (`id_nilai`, `nama_anggota`, `n_kerapian`, `n_kerjasama`, `n_etika`,`n_kedisiplinan`, `n_tanggungjawab`, `n_inisiatif` ) VALUES
(4, 'Mohamad Farkhan', 90, 90, 90, 90, 80),
(5, 'Muhammad Galuh Rianto', 85, 85, 85, 90, 80),
(6, 'Putri Dwi Maharani', 90, 75, 75, 90, 80),
(7, 'Sifa Faujia', 75, 75, 75, 90, 80),
(8, 'Prayogi Dwi Cahyo', 80, 95, 80, 90, 80);
